...
class _EducationTrainingScreenState extends State<EducationTrainingScreen> {
  ...
  VoidCallback _onBackPress() {
    return () {
      //TODO on Back Press
    };
  }

  VoidCallback _onSavePress() {
    return () {
  ...
  Widget _getAchievementsSection(Achievements achievements) {
    ...
    print("FETCH Achievements ${jsonEncode(achievements)}");
    ...
    widgets.add(_mapAchievement(achievements.languages, bloc.achievementsChangesController.langaugesSink));

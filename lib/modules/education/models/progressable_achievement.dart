...
class ProgressableItem {
  ...
  ProgressableItem({this.key, this.name, this.image, this.levels, this.selectedLevel});
  ...
  ProgressableItem cloneWith(int selectedLevel) {
    return ProgressableItem(
        key: this.key, name: this.name, image: this.image, levels: this.levels, selectedLevel: selectedLevel);
  }
}

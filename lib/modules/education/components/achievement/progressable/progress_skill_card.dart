...
class _ProgressSkillCardState extends State<ProgressSkillCard> {
  ...
  void initState() {
    super.initState();
    knowledgeLevel = widget.data.levels[0];
  }
              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    DraggableProgress(widget.data.levels, (newLevel) {
                      setState(() {
  ...
  void onDataChanged() {
    widget.onNewLevelSelected(widget.data.cloneWith(widget.data.levels.indexOf(knowledgeLevel)));
  }
}
